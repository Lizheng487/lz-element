...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".lz-collapse-item__header");
    contents = wrapper.findAll(".lz-collapse-item__wapper");
  ...
  //       [
  //         [
  //           [LzUILzror: [LzCollapse]:accordion mode should only have one active item],
  //         ],
  //       ]
  //     `
  //   );
