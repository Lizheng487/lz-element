...
import { computed, inject, nextTick, onMounted, onUnmounted, provide, reactive, ref, toRefs, useSlots, watch, watchEffect, type Ref } from 'vue';
...
<template>
  <div class="lz-form-item" :class="{
    ...
    <component v-if="hasLabel" class="lz-form-item__label" :class="`position-${ctx?.labelPosition ?? `right`}`"
    ...
    <div class="lz-form-item__content">
      ...
      <div class="lz-form-item__error-msg" v-if="validateStatus === 'error'">
...
.lz-form-item {
  --lz-form-label-width: v-bind(normalizeLabelWidth) !important;
}
</style>