...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".lz-message-box__header");
    const title = document.querySelector(".lz-message-box__title");
    const message = document.querySelector(".lz-message-box__message");
