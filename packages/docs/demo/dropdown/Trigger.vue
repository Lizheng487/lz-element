...
import { type DropdownItemProps } from "lz-element";
...
<template>
  <div class="row">
    ...
    <div class="col">
      ...
      <lz-dropdown :items="items" trigger="click">
        <span class="dropdown-link">
          Dropdown List
          <lz-icon icon="angle-down" />
        </span>
    ...
    <div class="col">
      ...
      <lz-dropdown :items="items" trigger="contextmenu">
        <span class="dropdown-link">
          Dropdown List
          <lz-icon icon="angle-down" />
        </span>
...
.desc {
  display: block;
  color: var(--lz-text-color-secondary);
  font-size: 14px;
  margin-bottom: 20px;
}
.dropdown-link {
